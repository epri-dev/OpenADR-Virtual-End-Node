...
namespace Oadr.Ven.UserControls.Resources.UI
{
    partial class StorageControl
    {
        ...
        {
            this.ucResource1 = new ResourceControl();
            this.tbChargeRate = new TextBoxControl();
            this.tbDischargeRate = new TextBoxControl();
            this.tbMaxCapacity = new TextBoxControl();
            this.ucCapacity = new SliderControl();
        ...
        private ResourceControl ucResource1;
        protected TextBoxControl tbChargeRate;
        protected TextBoxControl tbDischargeRate;
        protected TextBoxControl tbMaxCapacity;
        private SliderControl ucCapacity;
